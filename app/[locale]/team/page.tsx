...
import Image from 'next/image' // IMPORTIAMO IMAGE DA NEXT.JS
import { ArrowLeft, Mail } from 'lucide-react' // Ho rimosso 'User' perché usiamo le foto
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-white/5 p-6 rounded-xl flex flex-col items-center text-center transition-all duration-300 hover:shadow-lg hover:border-cyan-500/50 group">
              <div className="w-24 h-24 mb-4 overflow-hidden rounded-full border-4 border-cyan-100 dark:border-cyan-500/20 group-hover:scale-110 transition-transform duration-300">
                <Image 
                  src="PratiPFP.png" // CAMBIA QUI IL NOME DEL FILE
                  alt="Prati Manuel"
                  width={96}
                  height={96}
              ...
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-1">Prati Manuel</h3>
              <p className="text-sm font-medium text-cyan-600 dark:text-cyan-500 mb-6">{t('dev')}</p>
              <a href="mailto:manuelprati08@gmail.com" className="mt-auto flex items-center justify-center gap-2 text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-cyan-500 dark:hover:border-cyan-500 text-slate-700 dark:text-slate-300 py-2.5 px-4 rounded-lg transition-colors w-full font-semibold shadow-sm">
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-white/5 p-6 rounded-xl flex flex-col items-center text-center transition-all duration-300 hover:shadow-lg hover:border-blue-500/50 group">
              <div className="w-24 h-24 mb-4 overflow-hidden rounded-full border-4 border-blue-100 dark:border-blue-500/20 group-hover:scale-110 transition-transform duration-300">
                <Image 
                  src="AtienzaPFP.png" // CAMBIA QUI IL NOME DEL FILE
                  alt="Atienza Daniele"
                  width={96}
                  height={96}
                  className="w-full h-full object-cover"
              ...
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-1">Atienza Daniele</h3>
              <p className="text-sm font-medium text-blue-600 dark:text-blue-500 mb-6">{t('role1')}</p>
              <a href="mailto:atienzadaniele4@gmail.com" className="mt-auto flex items-center justify-center gap-2 text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 text-slate-700 dark:text-slate-300 py-2.5 px-4 rounded-lg transition-colors w-full font-semibold shadow-sm">
                <Mail className="w-4 h-4" /> {t('emailUs')}
              </a>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-white/5 p-6 rounded-xl flex flex-col items-center text-center transition-all duration-300 hover:shadow-lg hover:border-emerald-500/50 group">
              <div className="w-24 h-24 mb-4 overflow-hidden rounded-full border-4 border-emerald-100 dark:border-emerald-500/20 group-hover:scale-110 transition-transform duration-300">
                <Image 
                  src="EbraicoPFP.png" // CAMBIA QUI IL NOME DEL FILE
                  alt="Ebraico Lorenzo"
                  width={96}
                  height={96}
                  className="w-full h-full object-cover"
              ...
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-1">Ebraico Lorenzo</h3>
              <p className="text-sm font-medium text-emerald-600 dark:text-emerald-500 mb-6">{t('role2')}</p>
              <a href="mailto:lorenzo.ebraico@gmail.com" className="mt-auto flex items-center justify-center gap-2 text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 dark:hover:border-emerald-500 text-slate-700 dark:text-slate-300 py-2.5 px-4 rounded-lg transition-colors w-full font-semibold shadow-sm">
                <Mail className="w-4 h-4" /> {t('emailUs')}
              </a>
            </div>
